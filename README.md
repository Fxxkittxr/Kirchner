...
- CSS3: Design responsivo, animações de fade-in e estilização personalizada.

- JavaScript (Vanilla): Lógica de navegação SPA, gerenciamento de estado (carrinho/favoritos) e integração com API do WhatsApp.
...
- Catálogo Dinâmico: Listagem de produtos organizada por categorias (Compressores, Gases, Ferramentas, etc.).

- Sistema de Busca: Barra de pesquisa funcional que filtra itens pelo nome em tempo real.

- Favoritos: Permite ao usuário marcar produtos de interesse.

- Carrinho de Orçamento: Sistema onde o cliente adiciona quantidades e itens específicos.

- Integração com WhatsApp: Ao finalizar o pedido, o sistema gera uma mensagem formatada com a lista de produtos e quantidades, enviando-a diretamente para o número da empresa.
...
- style.css: Estilização completa, definição de cores da marca e regras de layout (Grid e Flexbox).
...
Certifique-se de que os três arquivos (index.html, style.css e script.js) estão na mesma pasta.
